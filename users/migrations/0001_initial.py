    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('town', models.CharField(blank=True, max_length=50, null=True, verbose_name='Город')),
                ('last_login', models.DateTimeField(default=datetime.datetime(2024, 3, 15, 12, 46, 25, 763478), verbose_name='Дата последнего входа')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('payment_date', models.DateTimeField(default=datetime.datetime(2024, 3, 15, 12, 46, 25, 764506), verbose_name='Дата платежа')),
                ('payment_amount', models.PositiveSmallIntegerField(verbose_name='Сумма платежа')),
                ('payment_method', models.CharField(choices=[('cash', 'Оплата наличными'), ('transfer', 'Перевод')], verbose_name='Способ оплаты')),
